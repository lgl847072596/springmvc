...
public class TbOldApp implements Serializable {
	...
	public String toString() {
		return "TbOldApp [appId=" + appId + ", appName=" + appName + ", packageName=" + packageName + ", platform="
				...
				+ ", updateTime=" + updateTime + ", url=" + url + ", belongAccount=" + belongAccount + ", categoryId="
				+ categoryId + "]";
	}
